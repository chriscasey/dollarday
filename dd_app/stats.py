...
def results_all(request):
	...
	score_win_perc = float(score_win_count)/result_count*100
	score_exa_perc = float(score_exa_count)/result_count*100
	score_tri_perc = float(score_tri_count)/result_count*100
	score_sf_perc = float(score_sf_count)/result_count*100
	avg_earnings_win_perc = float(avg_earning_win_count)/result_count*100
	avg_earnings_exa_perc = float(avg_earning_exa_count)/result_count*100
	avg_earnings_tri_perc = float(avg_earning_tri_count)/result_count*100
	avg_earnings_sf_perc = float(avg_earning_sf_count)/result_count*100

	win_perc_win_perc = float(win_perc_win_count)/result_count*100
	win_perc_exa_perc = float(win_perc_exa_count)/result_count*100
	win_perc_tri_perc = float(win_perc_tri_count)/result_count*100
	win_perc_sf_perc = float(win_perc_sf_count)/result_count*100

	avg_speed_win_perc = float(avg_speed_win_count)/result_count*100
	avg_speed_exa_perc = float(avg_speed_exa_count)/result_count*100
	avg_speed_tri_perc = float(avg_speed_tri_count)/result_count*100
	avg_speed_sf_perc = float(avg_speed_sf_count)/result_count*100	
